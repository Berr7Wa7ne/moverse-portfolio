    ...
    <section className="section-padding bg-white relative overflow-hidden">
      <div className="container">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-[var(--gray-600)] mt-6 max-w-2xl mx-auto">
            Choose the perfect plan that fits your business needs. All plans include our signature 
            quality and support.
          </p>
        </div>
          ...
          {plans.map((plan, index) => (
            <div
              ...
              className={`relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 ${
                plan.popular ? 'ring-2 ring-[var(--accent-blue)] transform scale-105' : ''
              }`}
            >
              {plan.popular && (
              ...
              <div className="text-center mb-8">
                <div className="w-16 h-16 bg-[var(--accent-blue)] rounded-full flex items-center justify-center mx-auto mb-4 text-2xl">
                  {plan.icon}
                </div>
                ...
                <div className="flex items-baseline justify-center">
                  ...
                  <span className="text-[var(--gray-600)] ml-1">
                    {plan.period}
                  </span>
                </div>
              </div>
