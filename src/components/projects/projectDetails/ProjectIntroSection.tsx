...
const ProjectIntroSection: React.FC<ProjectIntroSectionProps> = ({
  ...
  console.log('liveUrl value:', liveUrl); 
      ...
      <div className="container py-8 md:py-10">
        ...
        <div className="relative mb-8 md:mb-10 overflow-hidden rounded-2xl">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <button
              className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-white/90 backdrop-blur flex items-center justify-center shadow-lg"
        ...
        {liveUrl && (
          <div className="flex justify-center mb-10">
            <a
              ...
              className="px-6 py-3 bg-[var(--accent-blue)] rounded-full flex items-center justify-center text-white hover:bg-[var(--primary-blue)] transition group"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 items-start">
          <div className="lg:col-span-2">
            ...
            <div className="flex items-start gap-4 mb-5">
              ...
              <p className="text-[var(--gray-700)] leading-7">{lead}</p>
            </div>

            <p className="text-[var(--gray-700)] leading-7">{body}</p>
          </div>
