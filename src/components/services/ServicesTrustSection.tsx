...
const ServicesTrustSection: React.FC = () => {
  const features = [
    {
      icon: '💰',
    ...
    },
    {
      ...
      description: 'Our experienced team of developers, designers, and marketers work together to deliver exceptional results.'
    },
    {
      icon: '📅',
      title: '15+ Years Experience',
      description: 'With over 15 years in the industry, we have the expertise and knowledge to handle any project.'
    },
    {
      icon: '🏆',
      title: 'Award Winning',
      description: 'Recognized for excellence in design and development, we deliver award-winning solutions.'
    }
  ];
            ...
            <div className="text-white space-y-8">
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <button className="w-16 h-16 bg-white/90 hover:bg-white rounded-full flex items-center justify-center transition-colors shadow-lg">
                    <svg className="w-6 h-6 text-[var(--accent-blue)] ml-1" fill="currentColor" viewBox="0 0 24 24">
...
export default ServicesTrustSection;
