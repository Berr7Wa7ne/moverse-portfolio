...
type NewsletterCompactProps = {
	headingPrimary?: string;
	headingAccent?: string;
};

const NewsletterCompact: React.FC<NewsletterCompactProps> = ({
	headingPrimary = "Subscribe",
	headingAccent = "For Expert IT Tips And Social Offer",
}) => {
			...
			<div className="container">
				<div className="text-center max-w-4xl mx-auto">
					...
					<h2 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-8">
						<span className="text-[var(--primary-blue)]">{headingPrimary}</span>{" "}
						<span className="text-[var(--accent-blue)]">{headingAccent}</span>
					</h2>
					<form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto">
						...
						<button type="submit" className="btn-primary bg-[var(--accent-blue)] hover:bg-[#2952cc] whitespace-nowrap px-8 py-4">
							Subscribe
						</button>
					</form>
				</div>
